	...
	<div class="login-form-1">
		<form id="forgot-password-form" class="text-left">
			...
			<div class="main-login-form">
				...
				<button type="submit" class="login-button"><i class="fa fa-chevron-right"><img src="Imagens/arrow16x16.png"></i></button>
			</div>
			<div class="etc-login-form">
                            <p>already have an account? <a href="TelaLogin.php">login here</a></p>
                            <p>new user? <a href="TelaCadastro.php">create new account</a></p>
			</div>
		</form>
	</div>
	<!-- end:Main Form -->
